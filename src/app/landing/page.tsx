    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white">
      ...
      <main className="container mx-auto px-4 text-black">
        <section className="text-center py-20">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Revolutionize Your Surveys with AI</h2>
        ...
        <section className="py-20">
          <h3 className="text-2xl md:text-3xl font-bold text-center mb-12">Key Features</h3>
        ...
        <section className="py-20">
          <h3 className="text-2xl md:text-3xl font-bold text-center mb-12">Pricing Plans</h3>
