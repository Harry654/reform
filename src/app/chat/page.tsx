...
export default function ChatSurvey() {
  const [messages, setMessages] = useState<Message[]>([
    { id: 1, text: "Hello! I'm SurveyAI. Let's start our conversation about your experience. How was your day today?", sender: 'ai' },
  ])
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      <header className="bg-white shadow-sm p-4">
        <h1 className="text-2xl font-semibold text-gray-800">ReformAI-[Survey Name]</h1>
      </header>
