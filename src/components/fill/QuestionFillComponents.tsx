...
export const MCQQuestionFill: React.FC<QuestionProps> = ({ question }) => {
  const { responses, updateResponse, skippedQuestion, survey } = useSurvey();
  ...
  return (
    <div
      id={id}
      className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md border mt-5"
    >
...
export const FileUploadQuestionFill: React.FC<QuestionProps> = ({
  ...
  const { updateResponse, skippedQuestion, survey } = useSurvey();
